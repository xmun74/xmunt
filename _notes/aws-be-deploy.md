...
> #### Free tier
>
> - 가입 시 100 USD의 AWS 크레딧이 제공.
> - 5개 서비스 이용시 100 USD의 크레딧이 추가 제공.
>   : Amazon Elastic Compute Cloud(Amazon EC2), Amazon Relational Database Service(Amazon RDS), AWS Lambda, Amazon Bedrock, AWS Budgets 등
>   [AWS 공식문서 설명](https://aws.amazon.com/ko/blogs/korea/aws-free-tier-update-new-customers-can-get-started-and-explore-aws-with-up-to-200-in-credits/)
